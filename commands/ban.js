...
module.exports = {
	...
	async execute(interaction) {
        ...
        connection.connect(function(err){
            ...
            connection.query("INSERT INTO hellbot_sanctions(server_id, target_id, executor_id, type, reason, sanctionDate) VALUES ('"+interaction.guild+"', '"+memberToBan+"', '"+interaction.user.id+"', 'ban', '"+reason+"', '"+today.toISOString().slice(0,10)+"')", function (err) {
                if (err) throw err;
            });
            connection.end();
        });
