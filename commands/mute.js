...
module.exports = {
	...
	async execute(interaction) {
        ...
        connection.connect(function(err){
            ...
            connection.query("INSERT INTO hellbot_sanctions(server_id, target_id, executor_id, type, reason, sanctionDate) VALUES ('"+interaction.guild+"', '"+memberToMute+"', '"+interaction.user.id+"', 'mute', '"+reason+"', '"+today.toISOString().slice(0,10)+"')", function (err, result, fields) {
                if (err) throw err;
                connection.end();
            });
        });
