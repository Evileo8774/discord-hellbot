...
module.exports = {
	...
	async execute(interaction) {
        ...
        connection.connect(function(err){
            ...
            connection.query("INSERT INTO logs(guild, username, logType, logDate, reason) VALUES ('"+interaction.guild+"', '"+memberToKick+"', 'kick', '"+today.toISOString().slice(0,10)+"', '"+reason+"')", function (err, result, fields) {
                if (err) throw err;
            });
            connection.end();
        });
